...
from CustomUser.api.serializers import UserRegSerializers
...
class CustomAuthLogin(ObtainAuthToken):
    ...
    def post(self,request,*args,**kwargs):
        ...
        if user.user_type=='Admin' and user.verified == False:
            return Response({
                'operations': 'can\'t login as admin until verified'
